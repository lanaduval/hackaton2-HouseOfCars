    ...
    <div div className="background">
      ...
      <div className="ContainerCredit">
        ...
        <div className="Member" >
          <img className="Photo" src="src/assets/img/crew/alicia.png" alt="alici dupil"/>
          <br />
          <h3>Alicia Dupil</h3>
        </div>
        <div className="Member" >
        ...
        <div className="Member" >
          <img className="Photo" src="src/assets/img/crew/vivien.png" alt="" />
          <br />
      ...
      <p>
        We are The Space-girls and we hope you enjoyed this project<br /> as much as we taked pleasure to realise it. 
      </p>
      <Footer />
    </div>
  );
